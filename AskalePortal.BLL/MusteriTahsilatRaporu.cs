...
//	{
//		public class MusteriTahsilatRaporu : BaseBLL<AskalePortal.Data.Models.MusteriTahsilati>
//		{

//            public MusteriTahsilatRaporu(IConfiguration configuration, IWebHostEnvironment env) : base(configuration, env)
//            {
//            }
//            public List<AskalePortal.Data.Models.MusteriTahsilati> GetAllFromSAP(DateTime Tarih)
//			{
//				List<AskalePortal.Data.Models.MusteriTahsilati> lstData = new List<AskalePortal.Data.Models.MusteriTahsilati>();
//				try
//				{
//					SAPConnection con = new SAPConnection(GetConfig());
//					IRfcFunction function = con.Repostory.CreateFunction("ZWEBI021");
...
//						Models.MusteriTahsilati c = new Models.MusteriTahsilati();

//						c.MANDT = table.Getstring("MANDT");
//						c.NAME1 = table.Getstring("NAME1");
//						c.KUNNR = table.Getstring("KUNNR");
