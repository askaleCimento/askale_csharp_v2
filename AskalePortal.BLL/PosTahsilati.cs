...
//	{
//		public class PosTahsilati:BaseBLL<AskalePortal.Data.Models.PosTahsilati>
//		{
//			public List<AskalePortal.Data.Models.PosTahsilati> GetAllFromSAP(DateTime Tarih)
//			{
//				List<AskalePortal.Data.Models.PosTahsilati> lstData = new List<AskalePortal.Data.Models.PosTahsilati>();
//				try
//				{
//					SAPConnection con = new SAPConnection(GetConfig());
//					IRfcFunction function = con.Repostory.CreateFunction("ZWEBI027");
...
//						Models.PosTahsilati c = new Models.PosTahsilati();
