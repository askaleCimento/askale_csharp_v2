...
[Route("api/educationvideoduration")]
public sealed class EducationVideoDurationController(
    IEducationVideoDurationService service)
    : EducationCrudController<EgitimVideoIzlemeTable>(service)
{
